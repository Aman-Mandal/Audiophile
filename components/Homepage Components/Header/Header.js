...
const Header = () => {
  ...
  return (
    <div className="flex flex-col-reverse md:flex-row justify-center px-10 md:px-20 bg-black h-full py-8 md:py-20 md:pt-6 ">
      ...
      <div className="mb-12 md:mb-0 md:w-1/2 mx-auto">
